...
def main():
    ...
    # Xử lý dữ liệu Logistics cho Tab 3 và 4
    wh_data = []
    ...
    with tabs[4]: # 🧠 AI ĐỀ XUẤT (PHẦN NÂNG CẤP CTO)
        st.subheader("🤖 AI STRATEGIC ADVISOR (V24.0)")
        
        # 1. AI Nhận định chung
        ...
        # 2. AI Đề xuất Thanh lý (Giữ nguyên logic sếp duyệt nhưng trình bày đẹp hơn)
        st.divider()
        if not danger_zone.empty:
            ...
            st.write("AI phân tích thấy nhóm máy này có chi phí sửa chữa vượt ngưỡng 30% giá trị máy mới:")
