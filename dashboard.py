...
def main():
    ...
    with tabs[1]:
        ...
        st.plotly_chart(px.treemap(df_display, path=['VÙNG', 'LINH_KIỆN'], values='CP', title="TREEMAP CHI PHÍ", color_discrete_sequence=ORANGE_COLORS), use_container_width=True)
